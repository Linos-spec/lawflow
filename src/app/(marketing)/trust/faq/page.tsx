...
const FAQ: { q: string; a: string }[] = [
  ...
  { q: "What happens if there's a security incident?", a: "We notify affected firms without undue delay and within 72 hours of confirming an incident, with what happened and any action needed. You can reach our security contact any time at security@linoscore.com." },
  ...
  { q: "Can I try it with fake data first?", a: "Yes — we recommend evaluating with fictional matters before entering live client data, and we're happy to set up a walkthrough. Email security@linoscore.com to arrange a security call." },
];
    ...
    <div style={{ minHeight: "100vh", background: "var(--bg-base)" }}>
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "3rem 1.25rem 5rem" }}>
        ...
        <p style={{ fontSize: "0.85rem", color: "var(--text-muted)", marginTop: "2.5rem", borderTop: "1px solid var(--border-light)", paddingTop: "1rem" }}>
          Still have questions? Email <a href="mailto:security@linoscore.com" style={{ color: "var(--brand)" }}>security@linoscore.com</a> and we&apos;ll set up a call. {POLICY_ENTITY} provides software, not legal services.
        </p>
      </div>
    </div>
  );
