...
export async function organizeDocument(input: {
  ...
  try {
    const { object } = await generateObject({
      ...
      system: `You are a legal document classifier for Linoscore Law. Analyze the document text and organize it: determine its type, propose a consistent professional title, list the parties, and add useful tags. Be concise and accurate.`,
