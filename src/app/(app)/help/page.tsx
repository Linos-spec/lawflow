    ...
    questions: [
      {
        ...
        a: "Linoscore Law sends notifications 24 hours before a deadline is due. You can customize notification preferences in Settings > Notifications.",
      },
      {
    ...
    questions: [
      {
        ...
        a: "Linoscore Law supports Hourly, Flat Fee, and Contingency billing types. You can set the billing type when creating a new invoice.",
      },
      {
    ...
    questions: [
      {
        ...
        a: "Linoscore Law has four roles: Admin (full access), Partner (case and billing management), Associate (case management), and Paralegal (limited access to assigned cases).",
      },
      {
